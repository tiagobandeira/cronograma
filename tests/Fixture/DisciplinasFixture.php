...
class DisciplinasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_disciplinas_materias1_idx' => ['type' => 'index', 'columns' => ['materia_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_disciplinas_materias1' => ['type' => 'foreign', 'columns' => ['materia_id'], 'references' => ['materias', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
