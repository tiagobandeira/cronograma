...
class MateriasController extends AppController
{
    ...
    public function view($id = null)
    {
        $materia = $this->Materias->get($id, [
            'contain' => ['AreaConhecimento', 'Disciplinas', 'HoraEstudo']
        ]);
    ...
    public function add()
    {
        ...
        $areaConhecimento = $this->Materias->AreaConhecimento->find('list', ['limit' => 200]);
        $this->set(compact('materia', 'areaConhecimento'));
    }
